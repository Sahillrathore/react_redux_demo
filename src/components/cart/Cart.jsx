...
const Cart = () => {
  ...
  return (
    <>
        <div className="cart-box pb-6 bg-zinc-100 w-full dark:bg-gray-900 dark:text-zinc-300">
            ...
            <table className='border w-2/3 text-start m-auto border-black p-2 rounded-b-lg dark:bg-gray-800 dark:border-zinc-600 dark:backdrop-blur-sm'>

              <thead>
                <tr >
                  <td className='px-4 py-2' ></td>
                  <td className='px-4 py-2' ></td>
                  <td className='px-4 py-2 font-semibold text-sm text-zinc-800 dark:text-zinc-300'>Product</td>
                  <td className='px-4 py-2 font-semibold text-sm text-zinc-800 dark:text-zinc-300'>Price</td>
                  <td className='pr-4 pl-8 py-2 font-semibold text-sm text-zinc-800 dark:text-zinc-300 '>Qty</td>
                  <td className='pr-4 pl-8 py-2 font-semibold text-sm text-zinc-800 dark:text-zinc-300 '>Subtotal</td>
                </tr>
              </thead>
              <tbody>
                {
            ...
            <div className="billing-section m-auto w-1/4 mt-8 dark:bg-gray-800 rounded-t-lg">
              <div className="cart-total border-black border pl-8 py-2 rounded-t-lg dark:border-zinc-600">
                <h4 className='font-semibold text-zinc-800 '>Cart Total</h4>
                <p className='font-medium mb-1 text-zinc-700'>Total Qty : {totalQty}</p>
                <p className='font-medium mb-1 text-zinc-700'>Shipping : Free</p>
                <p className='font-medium mb-1 text-zinc-700'>Discount : {actualDiscount.toFixed(2)}</p>
                <p className='font-medium mb-1 text-zinc-700'>Total Bill  : {cartTotal - actualDiscount}$</p>
              </div>
