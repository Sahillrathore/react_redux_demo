...
const About = () => {
  return (
    <>
        <div className="flex justify-evenly items-center p-6 pt-8 bg-zinc-100 about-container dark:bg-gray-900">
            <div className="w-1/3 about-txt">
        ...
        <div className="flex justify-evenly items-center p-6 pt-2 bg-zinc-100 about-container dark:bg-gray-900">
            
            <div className="about-image">
                <img src="https://kayako.com/wp-content/uploads/2022/03/ecommerce-customer-satisfaction-trends.jpg" alt="" className='max-w-lg' />
            </div>

            <div className="w-1/3 about-txt">
                <h2 className='text-4xl font-bold mb-2 text-reddish'>What We Offer</h2>
