...
const ProductLandingPage = () => {
    ...
    return (
        ...
        // className = "md:w-1/2 lg:w-1/2 md:mx-auto rounded"
        <>
            ...
            <div className="container px-5 py-24 pt-12 mx-auto">
                <div className="lg:w-full justify-center flex flex-wrap">
                    ...
                    <div className="lg:w-1/2  lg:pl-10 lg:py-6 mt-6 lg:mt-0 ">
                        ...
                        <h1 className="text-gray-900 dark:text-gray-200 lg:text-3xl md:text-2xl sm:text-2xl title-font font-medium mb-1">
                        ...
                        <div className="flex mb-4">
                            <span className="flex items-center">
                                ...
                                <span className="text-gray-600 dark:text-gray-300 ml-3">{productDetails.rating?.count} Reviews</span>
                            </span>
                        ...
                        <p className="leading-relaxed">
                            {productDetails.description?.slice(0, 310)}
                        </p>
                        <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5">
                            ...
                            <div className="flex ml-6 items-center">
                                ...
                                <div className="
                                ">
                                    <select className="rounded border appearance-none border-gray-300 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-200 focus:border-indigo-500 text-base pl-3 pr-10 dark:bg-gray-700">
                                        <option>SM</option>
                                        <option>M</option>
                                        <option>L</option>
                                        <option>XL</option>
